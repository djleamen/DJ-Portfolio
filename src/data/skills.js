...
export const frameworks = ["React", "Django", "Swing", "Express.js", "Vue.js", "Seaborn", 
                            "scikit-learn", "NLTK", "LangChain", "Uvicorn", "Bootstrap", "Three.js",
                            "WebGL", "Electron", "FastAPI", "PyTorch", "NumPy", "Pandas", "Matplotlib"];
...
export const coreConcepts = ["Computer Hardware", "Data Structures & Algorithms", 
                              ...
                              "Network Programming", "Defensive Programming", 
                              "Science", "Physics", "Mathematics", "Graphic Design", 
                              "Information Technology", "Testing", 
                              "Extract, Transform, Load (ETL)", "Open-Source Software",
...
export const soft = [
  ...
  "Teamwork", "Leadership", "Problem Solving", "Critical Thinking", "Creativity", 
  "Adaptability", "Time Management", "Decision Making", "Conflict Resolution", 
  "Networking", "Public Speaking", "Presentation", "Writing", "Research", 
  "Collaboration", "Innovation", "Resilience", "Advocacy", "E-Learning", 
  "Analytical Skills", "Data Entry", "Requirement Gathering", "Advertising", 
  "Accessibility", "Attention to Detail", "Stress Management", "Written Communication",
];